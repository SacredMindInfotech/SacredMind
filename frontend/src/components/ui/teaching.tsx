        ...
        <div>
            <div className="mx-auto px-4 md:px-[5%] lg:px-[10%] xl:px-[15%] py-16">
                <div className="text-center mb-16 min-h-[50vh] flex flex-col justify-center items-center bg-gray-100">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 montserrat-700">Come teach with us</h1>
                ...
                <div className="text-center mb-16 min-h-[50vh] flex flex-col justify-center items-center bg-gray-100">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 montserrat-700">Send us your application</h1>
