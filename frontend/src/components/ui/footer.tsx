    ...
    return (
        <section className="bg-gray-900">
            <div className="container px-6 py-12 mx-auto">
                <div>
                    <p className="text-2xl text-white font-black montserrat-700 mb-3 ">Sacred Mind Infotech Private Limited</p>
                ...
                <div className="grid grid-cols-1 gap-12 mt-10 montserrat-400 lg:grid-cols-3">
                    <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-1">
                        <div>
                            ...
                            {/* <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">hr@sacredmind.in</p> */}
                            <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">info@sacredmind.in</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">
                                <div>Showroom No. 6, Second Floor, Garg Complex,</div>
                                <div>Lajpat Nagar, Bishanpura, Zirakpur,</div>
                                <div> Sub Tehsil Zirakpur,  Distt. SAS Nagar, Mohali, Punjab</div>
                            </p>
                        </div>
